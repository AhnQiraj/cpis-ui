<template>
  <div>
    ...
    <!-- 选择器 -->
    <ibps-org-selector-dialog :visible="selectorVisible" :value="selectorValue" :multiple="multiple" @close="visible => (selectorVisible = visible)" @action-event="handleSelectorActionEvent" />
  </div>
</template>
<script>
import { get } from '@platform/api/platform/org/org'
import { getByAlias } from '@platform/api/platform/org/entity'

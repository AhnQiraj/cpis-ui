<template>
  <div>
    ...
    <!-- 选择器 -->
    <ibps-position-selector-dialog :visible="selectorVisible" :value="selectorValue" :multiple="multiple" @close="visible => (selectorVisible = visible)" @action-event="handleSelectorActionEvent" />
  </div>
</template>
<script>
import { get, getByAlias } from '@platform/api/platform/org/position'

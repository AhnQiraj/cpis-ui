<template>
  <div v-show="visible" class="ibps-contextmenu" :class="classes" :style="styles">
    <ibps-menu v-if="visible" ref="menu" :items="data" />
  </div>
</template>
<script>
/**

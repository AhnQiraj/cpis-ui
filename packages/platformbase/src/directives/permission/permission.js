import { hasPermission } from "@platform/mixins/permission"
import { PERMISSION_EFFECT } from "@platform/constant"
function checkPermission(el, binding, vnode) {
  ...
  } else if (PERMISSION_EFFECT === "hidden") {
    // 如果登录用户没有这个权限，则组件将会被隐藏

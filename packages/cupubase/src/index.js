import toolbar from '@cupu/framework/components/toolbar/index.vue'
import table from '@cupu/framework/components/table/index.vue'
import tree from '@cupu/framework/components/tree/index.vue'
import comb from '@cupu/framework/components/comb/index.vue'
import dialogTable from '@cupu/framework/components/dialogTable/index.vue'

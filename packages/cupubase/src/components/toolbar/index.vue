<template>
  <span class="d2p-toolbar">
    ...
    <d2-table-columns-filter v-if="columns != null" ref="columnsSetup" v-model="columnsFilter.value" :options="columnsFilter.options" :storage="storage" :text="_text.columnsSet" @change="handleColumnsFilterChanged" />
  </span>
</template>
<script>
...
export default {
  ...
  computed: {
    ...
    _text() {
      const def = {
        refreshBtn: this.$t('baseCommon.component.refreshBtn'),
        searchBtn: this.$t('baseCommon.component.searchBtn'),
        compactBtn: this.$t('baseCommon.component.compactBtn'),
        exportBtn: this.$t('baseCommon.component.exportBtn'),
        columnsSetBtn: this.$t('baseCommon.component.columnsSetBtn'),
        columnsSet: {}
      }
